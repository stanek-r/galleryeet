...
<html lang="cs" data-theme="corporate">
  ...
  <body class="text-base">
    ...
    <h1 class="text-center text-7xl w-full my-20">GallerYeet</h1>
    <div class="flex flex-col gap-y-3 w-[1024px] max-w-full mx-auto px-6">
      <p class="text-center">
    ...
    <!-- Start INFO section -->
    <div class="flex flex-col gap-y-3 w-[1024px] mt-10 max-w-full mx-auto px-6">
      <h2 class="text-4xl -ml-2 my-2">Co zde najdete?</h2>
      <p>
        Na tomto blogu najdete cenné rady, tipy a triky pro cestování i fotografování. Budu se s vámi dělit o své
        zkušenosti z cest po celém světě, představím vám neuvěřitelné destinace, které stojí za návštěvu, a ukážu vám,
        jak své dojmy zachytit prostřednictvím fotografií.
      </p>
      <p>
        Pokud jste nadšeným cestovatelem, amatérským nebo profesionálním fotografem, nebo prostě jen milovníkem krásy
        světa kolem nás, tento blog je pro vás! Připravte se na úžasnou cestu plnou inspirace, vzrušení a zábavy.
      </p>
      <p>
        Těšíme se na společná dobrodružství, objevování nekonečných možností a sdílení našich vzácných zážitků z cest.
        Vstupte do světa plného barev, emocí a vzpomínek, které navždy zůstanou v našich srdcích. Vítejte na palubě
        našeho cestovatelského a fotografického blogu!
      </p>
      <h2 class="text-4xl -ml-2 my-2">Co nás čeká v budoucnu?</h2>
      <p>
        V nadcházejících týdnech a měsících se chystám navštívit několik úžasných míst, která jsem si pečlivě vybral,
        abych se s vámi mohl podělit o své zážitky, fotografie a tipy. Nejprve zamířím na Island, zemi ohromující
        přírody, gejzírů, vodopádů a polární záře. Plánuji prozkoumat tento jedinečný ostrov, navštívit místa jako
        Národní park Thingvellir, ledovec Vatnajökull či černou lávovou pláž Reynisfjara. Těšte se na články o mých
        islandských dobrodružstvích, doporučení na nejlepší trekkingové trasy a rady, jak se připravit na náročné
        klimatické podmínky.
      </p>
      <p>
        Následně vyrazím do Japonska, země plné kontrastů, která dokonale kombinuje tradiční kulturu s moderní
        technologií. Mým cílem je navštívit jak rušné metropole jako Tokio, tak i malebné vesničky a chrámy, které se
        nacházejí v horských oblastech. Chci se zúčastnit i tradičních japonských festivalů a zjistit více o japonské
        kuchyni a čajových obřadech.
      </p>
      <p>
        A konečně, jako poslední destinace mě čeká návštěva Kostariky, země deštných pralesů, pláží a bohatého života
        divokých zvířat. Plánuji strávit čas v národních parcích, jako je Manuel Antonio a Corcovado, kde se pokusím
        zahlédnout zvířata, jako jsou třeba lenochodi, kapucíni a quetzalové. Sledujte můj blog, abyste nezmeškali
        dobrodružství z těchto fascinujících destinací a získali cenné tipy pro vaše vlastní cesty.
      </p>
    </div>
    <!-- End INFO section -->
